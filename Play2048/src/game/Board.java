...
public class Board {
    ...
    public void updateOpenSpaces() {
        ...
        openSpaces = new ArrayList<>();
        BoardSpot openSpot = new BoardSpot();
        for(int i = 0; i < 4; i++) {
    ...
    public void addRandomTile() {
        ...
        int randomIndex = StdRandom.uniform(openSpaces.size());
        BoardSpot temp = openSpaces.get(randomIndex);
        int row = temp.getRow();
        int col = temp.getCol();
        int value = 0;
